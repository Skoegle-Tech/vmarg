        ...
        <Grid container spacing={isMobile ? 2 : 4}>
          ...
          <Grid item xs={6} sm={4}>
            ...
            <Box component="nav" sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Link href="https://skoegle.in/aboutus.html" color="inherit" underline="hover" sx={{ opacity: 0.8 }}>
                About Us
              </Link>
              <Link href="/products" color="inherit" underline="hover" sx={{ opacity: 0.8 }}>
                Product
              </Link>
              <Link href="https://skoegle.in/contactus.html" color="inherit" underline="hover" sx={{ opacity: 0.8 }}>
                Contact
              </Link>
            </Box>
          </Grid>
